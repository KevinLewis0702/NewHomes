...
// export async function generateStaticParams({ params: { county } }) {
//   const cities = await fetch(
//     `${process.env.REACT_APP_API_URL}/api/cities?county=${encodeURIComponent(
//       county || ""
//     )}`
//   ).then((res) => res.json());
...
function PropertyPage({ params: { county, city } }) {
  ...
  }, [searchParams, currentPage, county, city]);
  ...
  if (city)
    crumbs.push({
      title: city,
      href: `/property/${county.toLowerCase()}/${city.toLowerCase()}`,
    });
